...
until [ "$selection" = "B" ]; do
	...
	echo "----------------------------------------------------------------------"
	echo ""
	echo "A )Automatically Populate Tables"	
	echo ""
   	echo "1 ) Season"
    echo "2 ) Match"
    echo "3 ) Referee"
...
insert into season
values('Fall 2016','Kenny FC');
insert into match
values(10,'2016-12-12',120,'Camp Nou');
insert into referee
values(10,'Spenny');
insert into coach
values(10,'Benny');
...
values(20,'Frenny');
insert into team
values(10,'Nguyen FC','Vietnam',10,20,30,40);
insert into team
values(20,'Nugyen FC','Vietnam',15,25,35,45);
insert into player
values(10,'Cenny',10,'Hong Kong','Forward',10,20,30,40);
insert into player
values(20,'Denny',20,'Kong Hong','Forward',15,25,35,45);
insert into awards
values('Fall 2016',20,01,'MVP');
insert into plays_in
values(10,10,2);
insert into plays_in
values(20,10,0);
insert into plays_for
values(10,10,'2012-12-12','2013-12-12');
insert into plays_for
values(20,20,'2012-12-12','2013-12-12');
insert into manages
values(10,10,'2012-12-12','2013-12-12');
insert into manages
values(20,20,'2012-12-12','2013-12-12');
insert into penalizes
values(10,10,10,'Tackle','2012-12-12');
insert into roster
values(10,10,'Summer 2016');
